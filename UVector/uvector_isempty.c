...
/*   Updated: 2019/05/22 12:10:52 by akharrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
**    NAME
**         uvector_isempty -- check if a vector is empty
**
**    SYNOPSIS
**         #include <libft.h>
**
**         int
**         uvector_isempty(struct s_vector *self);
**
**    PARAMETERS
**
...
inline int		uvector_isempty(struct s_vector *self)
{
