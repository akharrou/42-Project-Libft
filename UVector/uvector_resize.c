...
/*   Updated: 2019/05/22 19:08:47 by akharrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
**    NAME
**         uvector_resize -- resize a vector to a new size
**
**    SYNOPSIS
**         #include <libft.h>
**
**         struct s_vector
**         uvector_resize(struct s_vector instance, size_t 0);
**
**    PARAMETERS
**
...
struct s_vector		uvector_resize(struct s_vector instance, size_t new_size)
{
	void			*new_vector;
